...
public class ODataCreateTests
{
    ...
    [Test]
    public async Task CreateAsync_WithValidData_ShouldCreateNewEntry()
    {
        // Arrange
        ...
        [Test]
    public async Task CreateAsync_SameEntryTwice_ShouldReturnBadRequest()
    {
        // Arrange
        var expectedId = new Random().Next(1000, 5000);
        var expectedFirstName = "John";
