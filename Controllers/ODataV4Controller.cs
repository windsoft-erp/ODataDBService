...
namespace ODataDBService.Controllers
{
    ...
    public class ODataV4Controller : ControllerBase
    {
        ...
        public async Task<ActionResult<ODataQueryResult>> QueryAsync(string tableName,
        ...
        {
            var result = await _oDataV4Service.QueryAsync(tableName, select, filter, orderby, top, skip);
        ...
        {
            var result = await _oDataV4Service.DeleteAsync(tableName, key);
        ...
        {
            var result = await _oDataV4Service.UpdateAsync(tableName, key, data);
